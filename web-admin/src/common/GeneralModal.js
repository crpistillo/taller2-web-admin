...
class GeneralModal extends Component {
    ...
    _successBagde() {
        if (this.props.showDeleteSuccessBagde) {
            return <Badge color="success" pill>User deleted</Badge>
        } else return <div />
    }

    _errorBagde() {
        if (this.props.showDeleteErrorBagde) {
            return <Badge color="danger" pill>Error deleting user</Badge>
        } else return <div />
    }
    ...
    render() {
        ...
        const disabledButton =  this.props.showDeleteSuccessBagde || this.props.showDeleteErrorBagde
        return (
